...
// WiFi Config
const char* ssid = "**************"; //replace it with your wifi name 
const char* password = "**************"; 

// Gemini API Config
const char* Gemini_Token = "******************************************"; //Gemini API from "https://aistudio.google.com/app/api-keys?"
const char* Gemini_Max_Tokens = "80";

// Telegram Config
const String botToken = "******************************************";  //Telegram bot token or API key
const String chatId = "**************"; //Your Telegram ID (for multiple IDs: String chatIds[] = {"123456789", "987654321", "112233445" };)
...
void askGemini(String question) {
  ...
  String url = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-lite:generateContent?key=" + String(Gemini_Token); // You can change the AI module by changing "gemini-2.5-flash-lite" from the link
  http.begin(url);
  http.addHeader("Content-Type", "application/json");
